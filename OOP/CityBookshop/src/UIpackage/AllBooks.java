...
public class AllBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblBook.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Id", "Book Name", "Book Price", "Stock"
            }
        ));
    ...
    private void populateTable(){
        ...
        ArrayList<Books> bookList = bh.viewAllTheBookDetails();
        ArrayList<Object[]> rows = new ArrayList<>();
        DefaultTableModel defaultTableModel = (DefaultTableModel) tblBook.getModel();
        
        for(Books book : bookList){
            Object[] row = {book.getBookId(), book.getBookName(), book.getPrice(), book.getAvailableStock()};
